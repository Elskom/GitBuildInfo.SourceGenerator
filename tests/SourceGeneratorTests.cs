...
#region C# 10 tests.
    ...
    {
        await TestGeneratingNoNamespace(Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp10).ConfigureAwait(false);
    }

    [Fact]
    public async Task TestGeneratingCustomNamespaceCSharp10()
    {
        await TestGeneratingCustomNamespace(Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp10).ConfigureAwait(false);
    }

    [Fact]
    public async Task TestGeneratingGenericCSharp10()
    {
        await TestGeneratingGeneric(Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp10).ConfigureAwait(false);
    }
#endregion
...
#region C# 9 tests.
    ...
    private static async Task TestGeneratingDefaultNamespace(Microsoft.CodeAnalysis.CSharp.LanguageVersion languageVersion = Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp9)
    {
        await RunTest<CSGeneratorTest>(string.Empty, "Test", "false", languageVersion == Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp10 ? @"// <autogenerated/>
...
}", languageVersion, languageVersion == Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp10 ? GetCSharp10Diagnostics("Test", otherEndColumn: 92) : GetDiagnostics()).ConfigureAwait(false);
    }

    private static async Task TestGeneratingNoNamespace(Microsoft.CodeAnalysis.CSharp.LanguageVersion languageVersion = Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp9)
    {
        await RunTest<CSGeneratorTest>(string.Empty, "Test", "false", languageVersion == Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp10 ? @"// <autogenerated/>
...
", @"namespace Elskom.Generic.Libs {
    ...
    private static async Task TestGeneratingCustomNamespace(Microsoft.CodeAnalysis.CSharp.LanguageVersion languageVersion = Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp9)
    {
        await RunTest<CSGeneratorTest>("TestNamespace", "Test", "false", languageVersion == Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp10 ? @"// <autogenerated/>
...
}", languageVersion, languageVersion == Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp10 ? GetCSharp10Diagnostics("Test", otherEndColumn: 92) : GetGenericDiagnostics()).ConfigureAwait(false);
    }

    private static async Task TestGeneratingGeneric(Microsoft.CodeAnalysis.CSharp.LanguageVersion languageVersion = Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp9)
    {
        await RunTest<CSGeneratorTest>(string.Empty, "Test", "true", languageVersion == Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp10 ? @"// <autogenerated/>
...
", @"namespace Elskom.Generic.Libs {
...
}", languageVersion, languageVersion == Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp10 ? GetCSharp10Diagnostics("Test<>") : GetDiagnostics()).ConfigureAwait(false);
    }
    ...
    private static async Task RunTest<TestType>(string rootNs, string assemblyType, string isGeneric, string generatedSource,
        string testSource, Microsoft.CodeAnalysis.CSharp.LanguageVersion languageVersion = Microsoft.CodeAnalysis.CSharp.LanguageVersion.CSharp9, List<DiagnosticResult>? expectedDiagnostics = null)
